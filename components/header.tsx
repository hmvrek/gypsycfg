    ...
    <header className="relative z-20 w-full">
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          ...
          {/* Discord Button */}
          <a
            href="https://discord.gg/wVfGXuknVc"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Button
              className="rounded-full h-10 px-5 bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium flex items-center gap-2 shadow-lg shadow-[#5865F2]/25 hover:shadow-[#5865F2]/40 transition-all duration-300"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
